...
(function() {
  ...
  //contenuto common topbar
  setTimeout(function(){document.getElementById("topbar").innerHTML+= '<a href="index.html?lang=' + lang + '" class="back-arrow"></a><div class="logo-microninja"></div>';}, 500);
