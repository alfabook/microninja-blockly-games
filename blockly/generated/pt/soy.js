...
BlocklyGames.soy.levelLinks = function(opt_data, opt_ignored, opt_ijData) {
  ...
  for (var i175 = 1; i175 < iLimit175; i175++) {
    output += ' ' + ((i175 == opt_data.level) ? '<span class="level_number level_done" id="level' + soy.$$escapeHtml(i175) + '">' + soy.$$escapeHtml(i175) + '</span>' : (i175 == opt_data.maxLevel) ? '<a class="level_number" id="level' + soy.$$escapeHtml(i175) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i175) + soy.$$escapeHtml(opt_data.suffix) + '">' + soy.$$escapeHtml(i175) + '</a>' : '<a class="level_dot" id="level' + soy.$$escapeHtml(i175) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i175) + soy.$$escapeHtml(opt_data.suffix) + '"></a>');
  }
  return output;
};
if (goog.DEBUG) {
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">Este n\u00EDvel \u00E9 extremamente dif\u00EDcil. Deseja ignor\u00E1-lo e ir para o pr\u00F3ximo jogo? Sempre pode voltar mais tarde.<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Cancelar</button><button id="abortOk" class="secondary">OK</button></div></div>';
};
if (goog.DEBUG) {
